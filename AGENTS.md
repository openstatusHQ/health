...
- `packages/<name>/` — one npm/JSR package per concern. `health` is the
  ...
  `drizzle`, `grpc`, `inngest`, `kafka`, `meilisearch`, `memory`, `mongodb`,
  `mysql`, `nats`, `neon`, `openai`, `planetscale`, `postgres`, `posthog`,
  `prisma`, `qstash`, `redis`, `resend`, `s3`, `sentry`, `stripe`, `supabase`,
  `tcp`, `tinybird`, `tls`, `trigger-dev`, `turso`, `turso-serverless`,
  `typesense`, `unkey`, `upstash`, `workos` are probes; `fly`, `koyeb`,
